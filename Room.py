class Room():
    ...
    def __init__(self,items: list[str],conditions: list[str]):
        # assigns pointers to variables in game.py
        self.items = items
    ...
    def location_outcome(self,location: "Room",text: str):
    ...
    def flavor_outcome(self,text: str,remove: bool):
